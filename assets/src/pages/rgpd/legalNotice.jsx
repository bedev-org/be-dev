        ...
        >
          <div className="flex flex-col text-center justify-center items-center max-w-7xl whitebedev-text font-bold ">
            <div className="text-2xl lg:text-3xl font-medium title-font  mx-96 text-black yellowbedev p-6 rounded-md shadow-lg">
              <h1 class="text-xl uppercase">Mentions légales</h1>
            </div>
          </div>
        </div>
        <div className="blackbedev text-white p-10">
          ...
          <section className="pt-6">
            ...
            <p>
              ...
              préalable est strictement interdite. Nous nous engageons à
              protéger la propriété intellectuelle et à prendre des mesures
              légales contre toute utilisation non autorisée.
            </p>
            <br />
          </section>
          ...
          <section>
            ...
            <br />
            <p>
              Les informations personnelles collectées sur ce site sont
              destinées à BE-DEV et ne seront en aucun cas cédées ou vendues à
              des tiers. Conformément à la loi, vous disposez d'un droit
              d'accès, de rectification et de suppression de vos données. Votre
              vie privée est importante pour nous, et nous nous engageons à
              protéger vos informations personnelles conformément aux normes de
              confidentialité.
            </p>
            <br />
          </section>
          ...
          <section>
            ...
            <p>
              ...
              personnaliser votre expérience en ligne et analyser la manière
              dont vous interagissez avec notre site.
            </p>
            <br />
          </section>
