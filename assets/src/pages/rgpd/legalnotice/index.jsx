...
const LegalNotice = () => {
  return (
    <>
      {" "}
      <div className="mentions-legales-container lg:text-3xl text-6xl ">
        <div className="grid justify-items-center">
          <h1 className=" text-9xl">Mentions Légales</h1>
        </div>
        <br />
        <section>
        ...
        <section>
          <h3 className="text-3xl">3. Hébergeur du Site</h3>
          <br />
        ...
        <section>
          <h3 className="text-3xl">4. Propriété Intellectuelle</h3>
          <br />
          <p>
        ...
        <section>
          <h3 className="text-3xl">5. Collecte de Données Personnelles</h3>
          <br />
          <p>
        ...
        <section>
          <h3 className="text-3xl">6. Cookies</h3>
          <br />
          <p>
        ...
        <section>
          <h3 className="text-3xl">7. Responsabilité</h3>
          <br />
          <p>
        ...
        <section>
          <h3 className="text-3xl">8. Loi Applicable</h3>
          <br />
          <p>
